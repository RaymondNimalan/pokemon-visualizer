        ...
        >
            ...
            <div className='flex flex-col sm:flex-row gap-4'>
                <div className='flex-1 flex justify-center items-center'>
                    <img
                        src={imageUrl}
                        className='w-full h-auto max-w-[300px] p-2'
                        alt={pokemonData.name}
                    />
                </div>

                <div className='flex-1 grid grid-cols-2 gap-4'>
                    <div className='flex flex-col p-2 bg-white rounded-lg shadow-inner text-gray-800'>
                    ...
                    <div className='col-span-2 flex flex-col p-2 bg-white rounded-lg shadow-inner text-gray-800'>
                ...
                <div className='flex flex-col sm:flex-row gap-4'>
                    <div className='flex-1 flex flex-col gap-2'>
                        {pokemonData?.stats.map((stat, index) => (
                            ...
                            >
                                <span className='capitalize w-[120px]'>
                                    {stat.stat.name}
                                </span>
